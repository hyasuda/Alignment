...
void Alignment( string filebase = "print_011_", int fCut = 100, int fCut_scan = 100){
  ...
  TH1D *hnoise_tgt  = new TH1D("hnoise_tgt","noise target",250,-1.0,7.0);
  ...
  hbcut_scan->GetYaxis()->SetRangeUser(0.,8.);
  // TH1 *hbcut_scan = 0;
