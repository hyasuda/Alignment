...
void Sumarry5300(){
    ...
    TH1D *hist = new TH1D("5300Raw","5300Raw",n,RangeMin,RangeMax);
    TH1D *hist2 = new TH1D("5300RawSquared","5300RawSquared",n,RangeMin,RangeMax);
    TGraph *h1 = new TGraph("/Users/YASUDA/ANALYSIS/InterferenceFringe/Displacement/5300.dat");
    TH1 *hm = 0;
    TH1 *hmcut = 0;
    TH1 *hbcut = 0;
    h_diff   = new TH1D(  "Diff",  "Diff",n,0,7500);
    h_diffsw = new TH1D("Diffsw","Diffsw",n,0,7500);
    TH1D *hnoise = new TH1D("hnoise","hnoise",10,-0.4,0.4);

    ifstream data("/Users/YASUDA/ANALYSIS/InterferenceFringe/Displacement/5300.dat");
