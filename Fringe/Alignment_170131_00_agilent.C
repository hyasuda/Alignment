...
void Alignment(int fCut = 100){
    ...
    TGraph *h1 = new TGraph("/Users/YASUDA/Data/Alignment/170131/print_011.dat");
    // TH1 *hm = 0;
    // TH1 *hmcut = 0;
    ...
    TH1D *hnoise = new TH1D("hnoise","hnoise",400,-2.0,8.0);

    ifstream data("/Users/YASUDA/Data/Alignment/170131/print_011.dat");
