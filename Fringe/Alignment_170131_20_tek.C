...
void Alignment(int fCut = 100){
    ...
    TGraph *h1 = new TGraph("/Users/YASUDA/Data/Alignment/170131/tek0003.dat");
    // TH1 *hm = 0;
    // TH1 *hmcut = 0;
    ...
    ifstream data("/Users/YASUDA/Data/Alignment/170131/tek0003.dat");
